...
export const scheduleData: DaySchedule[] = [
  {
    ...
    items: [
      ...
      { id: '2', subject: 'Jam Ke 0 : Assesment Sejarah', subjectType: 'science', room: 'Kelas Masing Masing', startTime: '06.50', endTime: '07.35' },
      ...
      { id: '10', subject: 'Matematika', subjectType: 'math', room: 'Kelas XI-4', startTime: '12.05', endTime: '12.45' },
      { id: '11', subject: 'Istirahat', subjectType: 'break', room: 'Diluar Kelas', startTime: '12.45', endTime: '13.15' },
      { id: '12', subject: 'Matematika', subjectType: 'math', room: 'Kelas XI-4', startTime: '13.15', endTime: '13.55' },
      { id: '13', subject: 'Native', subjectType: 'language', room: 'Kelas XI-4', startTime: '13.55', endTime: '14.35' },
      { id: '14', subject: 'Mandarin', subjectType: 'language', room: 'Kelas XI-4', startTime: '14.35', endTime: '15.20' },
    ],
  },
];
