...
export const scheduleData: DaySchedule[] = [
  {
    ...
    items: [
      ...
      { id: '3', subject: 'Matematika', subjectType: 'math', room: 'Kelas XI-4', startTime: '07.35', endTime: '08.20' },
      { id: '4', subject: 'PAK', subjectType: 'religion', room: 'Kelas XI-4', startTime: '08.20', endTime: '09.05' },
      { id: '5', subject: 'Istirahat', subjectType: 'break', room: 'Diluar Kelas', startTime: '09.05', endTime: '09.35' },
      { id: '6', subject: 'Lab Bahasa Inggris', subjectType: 'language', room: 'Lab Bahasa Inggris', startTime: '09.35', endTime: '10.20' },
      { id: '7', subject: 'Bahasa Inggris', subjectType: 'language', room: 'Kelas XI-4', startTime: '10.20', endTime: '11.05' },
      { id: '8', subject: 'Bahasa Sunda', subjectType: 'language', room: 'Kelas XI-4', startTime: '11.05', endTime: '11.50' },
      { id: '9', subject: 'Bahasa Indonesia', subjectType: 'language', room: 'Kelas XI-4', startTime: '11.50', endTime: '12.35' },
      { id: '10', subject: 'Istirahat', subjectType: 'break', room: 'Diluar Kelas', startTime: '12.35', endTime: '13.05' },
      { id: '11', subject: 'Bahasa Indonesia', subjectType: 'language', room: 'Kelas XI-4', startTime: '13.05', endTime: '13.50' },
      { id: '12', subject: 'PAK', subjectType: 'religion', room: 'Kelas XI-4', startTime: '13.50', endTime: '14.35' },
      { id: '13', subject: 'PAK', subjectType: 'religion', room: 'Kelas XI-4', startTime: '14.35', endTime: '15.20' },
    ],
  },
];
